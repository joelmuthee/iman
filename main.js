...
(async function () {
  ...
  function showSuspended() {
    ...
    const logoUrl = 'images/logo-nav-trans.png?v=2';
    ...
    const css = ('@keyframes imSusFade{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:none}}'
      ...
      + '#suspendedOverlay .im-ig{display:inline-flex;align-items:center;gap:10px;background:#bf9b30;color:#16140f;padding:14px 30px;border-radius:999px;text-decoration:none;font-weight:600;font-size:15px;letter-spacing:0.3px;box-shadow:0 6px 24px rgba(191,155,48,0.3);transition:transform 0.2s ease,box-shadow 0.2s ease,background 0.2s ease;}'
